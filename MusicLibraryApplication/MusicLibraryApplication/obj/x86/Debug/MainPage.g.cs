#pragma checksum "C:\Users\burro\Documents\GitHub\MusicLibary\MusicLibraryApplication\MusicLibraryApplication\MainPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "FEA1B7023EE264AAA6260A5B72605375FDD8981E35A3529B4855A1C6303B271D"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MusicLibraryApplication
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            {
                if (lineNumber == 246 && columnNumber == 40)
                {
                    isobj6SourceDisabled = true;
                }
                else if (lineNumber == 252 && columnNumber == 44)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 200 && columnNumber == 40)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 147 && columnNumber == 40)
                {
                    isobj18SourceDisabled = true;
                }
                else if (lineNumber == 148 && columnNumber == 44)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 17: // MainPage.xaml line 136
                        ...
                        break;
                    case 18: // MainPage.xaml line 142
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 231 && columnNumber == 27)
                {
                    isobj3ItemsSourceDisabled = true;
                }
                else if (lineNumber == 130 && columnNumber == 27)
                {
