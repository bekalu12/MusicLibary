#pragma checksum "C:\Users\samuel.l.fitzsimmons\Source\Repos\MusicLibary\MusicLibraryApplication\MusicLibraryApplication\MainPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "6E7291093C3EFEF9C5F1DBC572FD1DB694DCD23E75AAAE05AF6437A0A743C497"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MusicLibraryApplication
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            {
                if (lineNumber == 482 && columnNumber == 40)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 441 && columnNumber == 40)
                {
                    isobj13SourceDisabled = true;
                }
                else if (lineNumber == 447 && columnNumber == 44)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 400 && columnNumber == 40)
                {
                    isobj18SourceDisabled = true;
                }
                else if (lineNumber == 406 && columnNumber == 44)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 17: // MainPage.xaml line 398
                        ...
                        break;
                    case 18: // MainPage.xaml line 400
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 467 && columnNumber == 27)
                {
                    isobj5ItemsSourceDisabled = true;
                }
                else if (lineNumber == 426 && columnNumber == 27)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 5: // MainPage.xaml line 465
                        this.obj5 = (global::Windows.UI.Xaml.Controls.ListView)target;
                        break;
                    case 10: // MainPage.xaml line 424
